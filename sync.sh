...
# This is a slightly modified script to be run on this repository. You can find the
# original version of the script on the arch wiki here:
...
lastupdate_url='https://mirrors.rit.edu/archlinux/lastupdate'
...
rsync_cmd() {
	local -a cmd=(rsync -rtlH --safe-links --delete-after ${VERBOSE} "--log-file=rsync.log" "--timeout=600" 
		"--contimeout=60" -p --delay-updates --no-motd "--temp-dir=${tmp}")
